...
<body>
        ...
        <div class="container-fluid">
            <div class="offcanvas-body">
                ...
                <span class="navbar-brand me-auto text-white">Clothing Management System</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 active" href="transaction.php">Transaction</a>
                    </li>
    ...
    <div class="container mt-5 d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="container d-flex justify-content-end align-items-center">
            <a class="btn btn-dark mx-1" href="transaction_add.php" role="button">Add</a>
            <a class="btn btn-dark mx-1" href="exportData.php" role="button">Export</a>
        </div>
    </div>
    <script>
