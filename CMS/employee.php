...
<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div class="container-fluid">
            <div class="offcanvas-body">
                ...
                <span class="navbar-brand me-auto text-white">Clothing Management System</span>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 active" href="employee.php">Employee</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5 d-flex flex-column justify-content-center align-items-center">
                    ...
                    while($row = $result->fetch_assoc()) {
                      echo "<tr>
                        ...
                        <td class='d-flex justify-content-center align-items-center'>
                          <a class='btn btn-secondary mx-1' href='employee_update.php?update=".$row["employee_id"]."' role='button'>Edit</a>
                          <a class='btn btn-danger mx-1' href='delete.php?delete_employee=".$row["employee_id"]."' role='button'>Delete</a>
                        </td>
                      </tr>";
                    }
                } else {
        ...
        <div class="container d-flex justify-content-end align-items-center">
            <a class="btn btn-dark mx-1" href="employee_add.php" role="button">Add</a>
        </div>
    </div>
    <script>
