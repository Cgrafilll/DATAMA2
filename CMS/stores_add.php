...
<body>
    <div class="container my-5">
        <form class="mx-auto bg-white" action="stores_add.php" method="post">
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
                    ...
                    if (count($errors) === 0) {
                        ...
                        // Insert data into tbl_store table
                        $query = "INSERT INTO tbl_store (store_address, store_contact, store_email) 
                                VALUES ('$store_address', '$store_contact', '$store_email')";
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="store_contact" name="store_contact" placeholder="Enter store contact number" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="store_email" class="form-label">Store Email</label>
                <input type="text" class="form-control" id="store_email" name="store_email" placeholder="Enter store email" autocomplete="off">
            </div>
