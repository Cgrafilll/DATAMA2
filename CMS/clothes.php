...
<body>
        ...
        <div class="container-fluid">
            <div class="offcanvas-body">
                ...
                <span class="navbar-brand me-auto text-white">Clothing Management System</span>
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 active" href="clothes.php" aria-current="page">Clothes</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2" href="stores.php">Stores</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5 d-flex flex-column justify-content-center align-items-center">
              ...
              <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      echo "<tr>
                        <td>" .$row["clothes_code"] . "</td>
                        <td>" . $row["clothes_type"] . "</td>
                        <td>" . $row["brand_name"] . "</td>
                        <td>" . $row["stocks"] . "</td>
                        <td>" . $row["price"] . "</td>
                        <td class='d-flex justify-content-center align-items-center'>
                          <a class='btn btn-secondary mx-1' href='clothes_update.php?update=".$row["clothes_code"]."' role='button'>Edit</a>
                          <a class='btn btn-danger mx-1' href='delete.php?delete_clothes=".$row["clothes_code"]."' role='button'>Delete</a>
                        </td>
                      </tr>";
                    }
                } else {
        ...
        <div class="container d-flex justify-content-end align-items-center">
            <a class="btn btn-dark mx-1" href="clothes_add.php" role="button">Add</a>
        </div>
    </div>
    <script>
