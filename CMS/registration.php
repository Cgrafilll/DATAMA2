        ...
        <form class="mx-auto bg-white" action="registration.php" method="post">
            ...
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $errors = array();
                    // Validation
                    if (empty($fname) || empty($mname) || empty($lname) || empty($email) || empty($password) || empty($confirm) || empty($userType) || $userType == "none") {
                    ...
                    if (count($errors) > 0) {
                        ...
                        if ($userType == "admin") {
                            ...
                            $query = "INSERT INTO tbl_employees (FNAME, MNAME, LNAME, EMAIL, PASSWORD) VALUES (?, ?, ?, ?, ?);";
                            $username = "Employee";
                        }
            ...
            <div class="mb-3">
                <p class="text-center">Already have an account? <a href="index.php" class="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Login Now!</a></p>
            </div>
        </form>
    </div>
    <script>
