...
<body>
    <div class="container my-5">
        <form class="mx-auto bg-white" action="employee_update.php?update=<?php echo $_GET["update"]; ?>" method="post">
            <?php
                ...
                if(isset($_GET["update"])) {
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        if (count($errors) > 0) {
                            ...
                            $query = "UPDATE tbl_employees SET FNAME = '$FNAME', MNAME = '$MNAME', LNAME = '$LNAME', EMAIL = '$EMAIL' WHERE employee_id = $id";
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="EMAIL" name="EMAIL" value="<?php echo isset($EMAIL) ? $EMAIL : ''; ?>" placeholder="Enter email address" autocomplete="off">
            </div>
