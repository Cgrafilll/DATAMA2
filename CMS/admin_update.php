...
<body>
    <div class="container my-5">
        <form class="mx-auto bg-white" action="admin_update.php?update=<?php echo $_GET["update"]; ?>" method="post">
            <?php
                ...
                if(isset($_GET["update"])) {
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        if (count($errors) > 0) {
                            ...
                            $query = "UPDATE tbl_admin SET FNAME = '$FNAME', MNAME = '$MNAME', LNAME = '$LNAME', EMAIL = '$EMAIL' WHERE admin_id = $id";
