...
<body>
    <div class="container my-5">
        <form class="mx-auto bg-white" action="admin_add.php" method="post">
            <?php
                ...
                if (isset($_POST["submit"])) {
                    ...
                    if (count($errors) > 0) {
                        ...
                        $query = "INSERT INTO tbl_admin (FNAME, MNAME, LNAME, EMAIL, PASSWORD) VALUES ('$FNAME', '$MNAME', '$LNAME', '$EMAIL', '$hashedPassword');";
